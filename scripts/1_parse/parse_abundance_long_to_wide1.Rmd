...
long_dt <- fread(sprintf("%s/data/mp142_TGVG1.1_MPA4_combined_abundance_table_longform1.tsv", find_rstudio_root_file()), sep = "\t", header = T)
...
write.table(wide_bac_sp_dt, file = sprintf("%s/intermediate_files/TGVG1.1_MPA4_combined_abundance.bacteria_species.wide.tsv", find_rstudio_root_file()), quote = F, sep = "\t", row.names = F, col.names = T)
rm(wide_bac_sp_dt)
```
...
write.table(wide_vir_ge_dt, file = sprintf("%s/intermediate_files/TGVG1.1_MPA4_combined_abundance.virus_genus.wide.tsv", find_rstudio_root_file()), quote = F, sep = "\t", row.names = F, col.names = T)
rm(wide_vir_ge_dt)
```
...
write.table(wide_bac_ge_dt, file = sprintf("%s/intermediate_files/TGVG1.1_MPA4_combined_abundance.bacteria_genus.wide.tsv", find_rstudio_root_file()), quote = F, sep = "\t", row.names = F, col.names = T)
rm(wide_bac_ge_dt)
```
