...
linesp <- prev_modeled_dt %>%
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1),
        legend.position = "Off")
linesp
ggsave(linesp, file = sprintf("%s/charts/virus_species_temporal_subsets_lines1.pdf", find_rstudio_root_file()), width = 6, height = 4)
...
linesp <- prev_modeled_dt %>%
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1),
        legend.position = "Off")
linesp
ggsave(linesp, file = sprintf("%s/charts/bacteria_species_temporal_subsets_lines1.pdf", find_rstudio_root_file()), width = 6, height = 4)
...
Saving model
```{r}
saveRDS(kmlModelp, file = sprintf("%s/intermediate_files/prev_SGBs_8_temp_subsets_model_abundance2.rda", find_rstudio_root_file()))
```
