...
ggsave(file = sprintf("%s/charts/all_SGBs_FIN_rf_top12_features.pdf",
                      find_rstudio_root_file()), 
                 width = 8, height = 4)
```
...
ggsave(file = sprintf("%s/charts/all_SGBs_GER_rf_top12_features.pdf",
                      find_rstudio_root_file()), 
                 width = 8, height = 4)
```
...
ggsave(file = sprintf("%s/charts/all_SGBs_USA_rf_top12_features.pdf",
                      find_rstudio_root_file()), 
                 width = 8, height = 4)
```
