...
ggsave(file = sprintf("%s/charts/virome_bray_curtis_T1D_NCC_paired.pdf", find_rstudio_root_file()), 
...
ggsave(file = sprintf("%s/charts/virome_T1D_and_dayoflife_bray_curtis_NCC_paired.pdf", find_rstudio_root_file()), 
                 width = 6, height = 3.5)  
```
...
ggsave(file = sprintf("%s/charts/bacteriome_bray_curtis_T1D_NCC_paired.pdf", find_rstudio_root_file()), 
                 width = 2.5, height = 3.5)  
```
...
ggsave(file = sprintf("%s/charts/bacteriome_T1D_and_dayoflife_bray_curtis_NCC_paired.pdf", find_rstudio_root_file()), 
                 width = 6, height = 3.5)  
```
